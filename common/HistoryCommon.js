	...
	function(window, undefined)
{
	...
	window['AscDFH'].historyitem_Pdf_Document_Merge_Pages		= window['AscDFH'].historyitem_type_PDF_Document | 11;
	window['AscDFH'].historyitem_Pdf_Document_Calc_Order		= window['AscDFH'].historyitem_type_PDF_Document | 12;
