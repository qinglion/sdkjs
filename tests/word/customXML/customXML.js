...
$(function () {
	...
	function CreateContentControl()
	{
		...
		logicDocument.AddToContent(0, para);
		return logicDocument.AddContentControl(c_oAscSdtLevelType.Block);
	}
	...
	const oCustomXMLs = {
		...
		'picture': "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<documentData xmlns=\"http://example.com/picture\">\n<simpleText>" + oCustomXMLData.onePicture + "</simpleText>\n</documentData>\"",
	...
	QUnit.test("Date and CheckBox content control's load/save from/to different CustomXML's", async function (assert)
	{
		...
		assert.strictEqual(
			...
			'<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<documentData xmlns=\"http://example.com/picture\">\n\t<simpleText>01/01/2000</simpleText>\n</documentData>',
	...
	QUnit.test("Date content control load/save from/to CustomXML", async function (assert)
	{
		CreateCustomXMLForDocument(oCustomXMLs.date);
	...
	QUnit.test("Checkbox content control load/save from/to CustomXML", async function (assert)
	{
	...
	QUnit.test("ComboBox content control load from/save to CustomXML", async function (assert)
	{
		CreateCustomXMLForDocument(oCustomXMLs.checkboxMess);
	...
	QUnit.test("DropDown content control load from/save to CustomXML", async function (assert)
	{
		CreateCustomXMLForDocument(oCustomXMLs.checkboxMess);
	...
	QUnit.test("Picture content control load from/save to CustomXML", async function (assert)
	{
	...
	QUnit.test("Simple text content control load from/save to CustomXML", async function (assert)
	{
		CreateCustomXMLForDocument(oCustomXMLs.checkboxMess);
		let c1			= 	CreateText(0);
		CreateDataBindingForCC(c1);
