...
AscFormat.CTheme.prototype.Document_Get_AllFontNames = function (AllFonts) {
	...
	// was typeof major_font.cs === "string" && major_font.latin.length > 0 && (AllFonts[major_font.cs] = 1);
	...
	// was typeof minor_font.cs === "string" && minor_font.latin.length > 0 && (AllFonts[minor_font.cs] = 1);
